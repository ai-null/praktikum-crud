...
<body>
    <div class="container position-relative position-absolute top-50 start-50 translate-middle">
        <a class="bi bi-arrow-left" style="font-size: 2rem; color: cornflowerblue;" href="login.php"></a>
        ...
        <form method="post" action="register.php">
            ...
            <?php if ($error) echo "<h6 class='error-msg'>Sadly, something went wrong with our server.<h6>"; ?>
